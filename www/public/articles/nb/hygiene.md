# Gode søvnvaner – grunnmuren for bedre søvn
...
- **Skjermbruk om kvelden** gir kortere og dårligere søvn, spesielt hos unge.  
  ([sciencedirect.com](https://www.sciencedirect.com/science/article/abs/pii/S2352721821000037))  

- **Koffein** selv seks timer før leggetid reduserer søvnlengde og søvnkvalitet.  
  ([jcsm.aasm.org](https://jcsm.aasm.org/doi/10.5664/jcsm.3170))  

- **Alkohol** gir mer oppstykket søvn og øker risiko for snorking/pustestopp.  
  ([sleepfoundation.org](https://www.sleepfoundation.org/nutrition/alcohol-and-sleep))
...
- American Academy of Sleep Medicine: *Caffeine Effects on Sleep* ([jcsm.aasm.org](https://jcsm.aasm.org/doi/10.5664/jcsm.3170))  
- Sleep Foundation: *Alcohol and Sleep* ([sleepfoundation.org](https://www.sleepfoundation.org/nutrition/alcohol-and-sleep))  
- ScienceDirect: *Evening screen use and sleep* ([sciencedirect.com](https://www.sciencedirect.com/science/article/abs/pii/S2352721821000037))
